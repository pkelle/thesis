...
plot1 = add_trace(plot1, x=time(Cyprus.DebtGDP) ,y = Cyprus.DebtGDP, name = 'Cyprus',mode = 'lines', line = list(width=1))
plot1 = add_trace(plot1, x=time(Ireland.DebtGDP) ,y = Ireland.DebtGDP, name = 'Ireland',mode = 'lines', line = list(width=1))
plot1 = add_trace(plot1, x=time(Italy.DebtGDP) ,y = Italy.DebtGDP, name = 'Italy',mode = 'lines', line = list(width=1))
plot1 = add_trace(plot1, x=time(Portugal.DebtGDP) ,y = Portugal.DebtGDP, name = 'Portugal',mode = 'lines', line = list(width=1))
plot1 = add_trace(plot1, x=time(Spain.DebtGDP) ,y = Spain.DebtGDP, name = 'Spain',mode = 'lines', line = list(width=1))
plot1 = layout(plot1, yaxis = list(ticksuffix = "%"))
plot1
